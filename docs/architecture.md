...
This document describes OctoAgent's technical architecture in detail. It's intended for developers who want to understand how the codebase works before making changes.

## Process Model

OctoAgent follows the standard Electron three-process model:
...
- **Configuration** -- Reading and writing JSON config files at `~/.octoagent/`
...
Manages "managed repositories" -- repos that OctoAgent knows about for features like worktree creation and GitHub integration.
