...
export function IsolationSettings({ isolated, skipApproval, dockerStatus, devcontainerStatus, hasDevcontainerConfig, onIsolatedChange, onSkipApprovalChange, onGenerateDevcontainerConfig }: {
  isolated: boolean
